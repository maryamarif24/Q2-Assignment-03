    ...
    return (
        <div>
            ...
            <div className="pt-[150px] mb-[100px]">
                <h1 className="font-extrabold font-sans text-4xl mx-[550px]">Login</h1>
                <form action="">
                    ...
                    <button className="bg-slate-900 text-white font-bold  p-4 px-[240px] rounded-full mx-[340px] hover:text-slate-900 hover:bg-red-500">Login</button>
                </form>
            </div>
            <Footer></Footer>
        </div>
